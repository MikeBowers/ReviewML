...
namespace ReviewMLBlazorAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"A:\MoreGithub\ReviewML\ReviewMLBlazorApp\Data\reviews2.csv";
        private static string MODEL_FILEPATH = @"C:\Users\Alienware\AppData\Local\Temp\MLVSTools\ReviewMLBlazorAppML\ReviewMLBlazorAppML.Model\MLModel.zip";
